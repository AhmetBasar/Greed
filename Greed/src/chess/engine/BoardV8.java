...
public class BoardV8 implements IBoard, EngineConstants {
...
//	private long zobristKey;
	...
	public BoardV8(long[] bitboard, byte[] pieces, int epT, byte[][] castlingRights, int fiftyMoveCounter, List<Long> zobristKeyHistory, int side) {
