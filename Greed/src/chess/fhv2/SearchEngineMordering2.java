...
public class SearchEngineMordering2 implements ISearchableV2, EngineConstants {
	...
	private static SearchEngineMordering2 instance;
	private static SearchEngineMordering2[] newInstances = new SearchEngineMordering2[16];
	...
	private SearchEngineMordering2(){
		TranspositionTable.fillZobristArrays();
		timeControllerThread.start();
	}
	
	public static SearchEngineMordering2 getInstance() {
		if (instance == null) {
			instance = new SearchEngineMordering2();
		}
		return instance;
	}
	
	public static synchronized SearchEngineMordering2 getNewInstance() {
		for (int i = 0; i < newInstances.length; i++) {
			if (newInstances[i] == null) {
				newInstances[i] = new SearchEngineMordering2();
