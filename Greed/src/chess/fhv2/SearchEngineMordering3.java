...
public class SearchEngineMordering3 implements ISearchableV2, EngineConstants {
	...
	private static SearchEngineMordering3 instance;
	private static SearchEngineMordering3[] newInstances = new SearchEngineMordering3[16];
	...
	private SearchEngineMordering3(){
		TranspositionTable.fillZobristArrays();
		timeControllerThread.start();
	}
	
	public static SearchEngineMordering3 getInstance() {
		if (instance == null) {
			instance = new SearchEngineMordering3();
		}
		return instance;
	}
	
	public static synchronized SearchEngineMordering3 getNewInstance() {
		for (int i = 0; i < newInstances.length; i++) {
			if (newInstances[i] == null) {
				newInstances[i] = new SearchEngineMordering3();
